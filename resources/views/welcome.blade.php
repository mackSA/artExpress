...
<nav>
    <div class="nav-wrapper">
      ...
      <ul class="right hide-on-med-and-down">
        <li><a href="{{URL::route('login_view')}}">Login</a></li>
      </ul>
    ...
    <div class="row">
        ...
        <div class="col s12 m4 push-m2 l4 push-l4 ">
            ...
            @include('includes.messages')
                <form action="{{route('signup')}}" method="POST" class="col s12 z-depth-5" style="padding-bottom: 20px">
                <div class="row">
                ...
                <div class="row">
                  <div class="input-field col s12">
                    <input id="first_name" name="fullname" type="text" class="validate">
                ...
                <button class="btn waves-effect waves-light" type="submit" name="sign_up">Submit
            ...
            <div class="row">
                <div class="z-depth-5 " style="text-align: center;padding: 15px;">
                    ...
                    <h6>Have an Account? <a href="{{route('login_view')}}">Login</a></h6>  
                </div>
            </div>      
        </div>
    </div>     
